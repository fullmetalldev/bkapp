        ...
        <>
            <section className="tablewareProduct">
                <div className="container">
                    <p className="section__navi">Главная / Каталог пластиковой посуды / Пластиковые контейнеры / Контейнер “Плошка”, 360мл</p>
                    ...
                    <div className="tablewareProduct__cards adaptive2">
                        <div className="tablewareProduct__cards_card">
                            <h2 className="tablewareProduct__cards_title">Ранее вы смотрели</h2>
                            <Swiper
                                slidesPerView={1}
